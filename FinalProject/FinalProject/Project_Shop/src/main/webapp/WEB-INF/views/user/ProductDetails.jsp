			...
			<div class="grid wide">
				<div class="row sm-gutter product-detail__info">
					...
					<div class="col l-7 m-12 c-12">
						<form action="cart/addcart" method="post" id="frmProductdetails">
								...
								<div class="product-detail__Configuration">
									<div style="padding: 0 20px;">
										...
										<c:if test="${not empty allcolor }">
											...
											<p id="errorNoClickoptionColor" style="color:red; margin-left: 120px; font-size: 1.3rem;"></p>
										</c:if>										
										...
										<div class="product-detail__quantity">
											...
											<div class="product-detail-available">
												<fmt:formatNumber type="NUMBER" maxIntegerDigits="3"
													value="${product.quantity - product.buyItem }" />
												sản phẩm có sẵn
											</div>
										</div>
