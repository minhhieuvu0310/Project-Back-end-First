                ...
                <div class="row  sm-gutter myAccount">
                    ...
                    <div class="col l-10 m-12 c-12">
                        <div class="myAccount-info-detail">
                            ...
                            <form:form  action="UpdateMyAccount" modelAttribute="users" method="post" enctype="multipart/form-data">
                                <div class="myAccount__form">
                                    <div class="myAccount__editInfo">
                                        <div class="myAccount__form-input">
                                            <div class="myAccount__group">
                                                ...
                                                <input class="myAccount__input" readonly="readonly" value="${users.getUserName() }"></input>
                                            </div>
                                            <div class="myAccount__group">
                                                <label for="" class="myAccount__label">Tên</label>
                                                <form:input  path="fullName" class="myAccount__input" value="${users.getFullName() }"></form:input>
                                            </div>
                                            <div class="myAccount__group">
                                                <label for="" class="myAccount__label">Email</label>
                                                <form:input  path="email" class="myAccount__input" value="${users.getEmail() }"></form:input>
                                            </div>
                                            <div class="myAccount__group">
                                                <label for="" class="myAccount__label">Phone</label>
                                                <form:input  path="phone" class="myAccount__input" value="${users.getPhone() }"></form:input>
                                            </div>
                                            <div class="myAccount__group">
                                                <label for="" class="myAccount__label">Address</label>
                                                <form:input path="address" class="myAccount__input" value="${users.getAddress() }"></form:input>
                                            </div>
                                        </div>
                                    ...
                                    <div class="myAccount__editAvatar">
                                        <img src="<c:url value="resources"/>/image/User/${users.getUserImage()}" alt="NoImage" class="myAccount__avatar">
                                        <input type="file" accept=".jpg,.jpeg,.png" style="display: none;" id="userImg" name="imageUser" >
                                        <label class="btn btn--choose-photo" id="btn--choose-photo" for="userImg">Chọn Ảnh</label>
                                        <div class="myAccount__avatar-descirption">
                                            <p class="myAccount__avatar-maxData">Dụng lượng file tối đa 1 MB</p>
                                            <p class="myAccount__avatar-typeFile">Định dạng:.JPEG, .PNG</p>
                                        </div>
                                    </div>
                                </div>
                            </form:form >
